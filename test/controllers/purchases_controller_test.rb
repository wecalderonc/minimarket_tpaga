...
class PurchasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase" do
    assert_difference('Purchase.count') do
      post purchases_url, params: { purchase: { product: @purchase.product, quantity: @purchase.quantity, user: @purchase.user } }
    end
  ...
  test "should update purchase" do
    patch purchase_url(@purchase), params: { purchase: { product: @purchase.product, quantity: @purchase.quantity, user: @purchase.user } }
